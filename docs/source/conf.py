# -*- coding: utf-8 -*-
#
# hep_spt documentation build configuration file, created by
...
import hep_spt
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(hep_spt.__file__)))
...
version = hep_spt.version.__version__
# The full version, including alpha/beta/rc tags.
release = hep_spt.version.__version__
...
latex_documents = [
    (master_doc, 'hep_spt.tex', u'hep_spt Documentation',
...
man_pages = [
    (master_doc, 'hep_spt', u'hep_spt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hep_spt', u'hep_spt Documentation',
     author, 'hep_spt', 'One line description of project.',
     'Miscellaneous'),
]
